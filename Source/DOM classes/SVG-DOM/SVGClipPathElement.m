...
- (void)postProcessAttributesAddingErrorsTo:(SVGKParseResult *)parseResult {
    ...
    NSError *error = [NSError errorWithDomain:@"SVGKit" code:1 userInfo:[NSDictionary dictionaryWithObjectsAndKeys:
                                                                         @"<clipPath> found in SVG. May render incorrectly with SVGKFastImageView due to Apple bug in CALayer .mask rendering.",
                                                                         @"No és possible descarregar la imatge.", nil]];
